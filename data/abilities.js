...
exports.Abilities = {
    ...
    iceface: {
        ...
        onWeatherChange: function (pokemon, source, sourceEffect) {
            ...
            if ((_a = sourceEffect) === null || _a === void 0 ? void 0 : _a.suppressWeather)
                return;
            if (!pokemon.hp)
                return;
            if (this.field.isWeather(['hail', 'snow']) &&
    ...
    protosynthesis: {
        ...
        onWeatherChange: function (pokemon) {
            ...
            else if (!((_a = pokemon.volatiles['protosynthesis']) === null || _a === void 0 ? void 0 : _a.fromBooster)) {
        ...
        condition: {
            ...
            onStart: function (pokemon, source, effect) {
                if ((effect === null || effect === void 0 ? void 0 : effect.id) === 'boosterenergy') {
    ...
    rattled: {
        ...
        onAfterBoost: function (boost, target, source, effect) {
            if ((effect === null || effect === void 0 ? void 0 : effect.name) === 'Intimidate') {
                this.boost({ spe: 1 });
            }
        },
        name: "Rattled",
