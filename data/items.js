...
exports.Items = {
    ...
    adamantcrystal: {
        ...
        onTakeItem: function (item, pokemon, source) {
            if ((source === null || source === void 0 ? void 0 : source.baseSpecies.num) === 483 || pokemon.baseSpecies.num === 483) {
                return false;
            }
            return true;
        },
    ...
    boosterenergy: {
        ...
        onUpdate: function (pokemon) {
            ...
            if (pokemon.transformed)
                return;
            if (((_a = this.queue.peek(true)) === null || _a === void 0 ? void 0 : _a.choice) === 'runSwitch')
                return;
    ...
    griseouscore: {
        ...
        onTakeItem: function (item, pokemon, source) {
            if ((source === null || source === void 0 ? void 0 : source.baseSpecies.num) === 487 || pokemon.baseSpecies.num === 487) {
                return false;
            }
            return true;
        },
    ...
    lustrousglobe: {
        ...
        onTakeItem: function (item, pokemon, source) {
            if ((source === null || source === void 0 ? void 0 : source.baseSpecies.num) === 484 || pokemon.baseSpecies.num === 484) {
                return false;
            }
            return true;
        },
    ...
    metronome: {
        ...
        condition: {
            ...
            onModifyDamage: function (damage, source, target, move) {
                ...
                this.debug("Current Metronome boost: ".concat(dmgMod[numConsecutive], "/4096"));
    ...
    roomservice: {
        ...
        onAnyPseudoWeatherChange: function () {
            var pokemon = this.effectState.target;
    ...
    vilevial: {
        ...
        onTakeItem: function (item, pokemon, source) {
            if ((source === null || source === void 0 ? void 0 : source.baseSpecies.num) === -66 || pokemon.baseSpecies.num === -66) {
                return false;
            }
            return true;
        },
